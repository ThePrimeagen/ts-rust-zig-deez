 ...
 * whiout having to return null, which is ambigous. The only way to produce this value is with the now valid "return;"
 * syntax or by calling a function the has this empty return statement. It cannot be assigned to a variable and trying
 * to do so will result in an Evaluation Error
 */
