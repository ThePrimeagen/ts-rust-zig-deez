...
/**
 * An expression that returns null, the "null" literal. This is a deviation from the Monkey
 * spec, but, if the language is going to have null values, there should be a way to produce
 * them and assign them to variables with a simple syntax like, "let a = null;". In the
