...
testAstLet ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "testAstLet" (Right expected) tree
...
testAstFn ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "testAstFn" (Right expected) tree
...
tokenAstCall ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "tokenAstCall" (Right expect) tree
...
tokenAstArith ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "tokenAstArith" (Right expect) tree
...
tokenAstArith2 ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "tokenAstArith2" (Right expect) tree
...
tokenAstIf ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "tokenAstIf" (Right expect) tree
...
tokenAstFnCallIf ast = TestCase $ do
    ...
    let tree = ast tokens
    assertEqual "tokenAstFnCallIf" (Right expect) tree
